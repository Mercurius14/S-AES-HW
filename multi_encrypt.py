...
def generate_all_keys():
    # for num1 in range(2 ** 16):
    #     for num2 in range(2 ** 16):
    #         key1 = bin(num1)[2:].zfill(16)
    #         key2 = bin(num2)[2:].zfill(16)
    #         yield (key1, key2)
    for i in range(2 ** 32):
    ...
    for key1, key2 in all_keys:
        ...
        for known_plain_text, known_cipher_text in zip(known_plain_text_list, known_cipher_text_list):
            ...
            if middle_text1 != middle_text2:
                ...
                break
        # middle_text1 = [Encrypt(known_plain_text, key1)
        #                  for known_plain_text in known_plain_text_list]
        # middle_text2 = [Decrypt(known_cipher_text, key2)
        #                  for known_cipher_text in known_cipher_text_list]
        # if middle_text1 == middle_text2:
